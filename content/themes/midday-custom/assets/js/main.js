...
const openCloseMenu = (() => {
	...
	const enableNavLinks = () => {
		...
		navMenu.classList.remove("menu-overlay--hidden")
	...
	const disableNavLinks = () => {
		...
		navMenu.classList.add("menu-overlay--hidden")
...
const handleNavMove = () => {
	...
	const originalParent = document.querySelector(".site-header__content")
	const parentNode = document.getElementById("page")
	const originalReference = document.querySelector(".site-header__branding")
