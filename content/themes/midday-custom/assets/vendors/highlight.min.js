			...
			((e) => {
				if (Array.isArray(e.begin)) {
					if (e.skip || e.excludeBegin || e.returnBegin)
						throw (z("skip, excludeBegin, returnBegin not compatible with beginScope: {}"), G)
			...
			((e) => {
				if (Array.isArray(e.end)) {
					if (e.skip || e.excludeEnd || e.returnEnd)
						throw (z("skip, excludeEnd, returnEnd not compatible with endScope: {}"), G)
					if ("object" != typeof e.endScope || null === e.endScope) throw (z("endScope must be object"), G)
			...
			function E(e, n, s, r) {
				...
				function h(e, t) {
					return (
						...
						e.beginScope &&
							(e.beginScope._wrap
								? (u(R, w.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), (R = ""))
				...
				function m(e) {
					...
					N.endScope && N.endScope._wrap
						...
						: N.endScope && N.endScope._multi
							...
							: r.skip
								? (R += t)
								: (r.returnEnd || r.excludeEnd || (R += t), g(), r.excludeEnd && (R = t))
					do {
			...
			Object.assign(n, {
				...
				registerLanguage: (e, t) => {
					...
					try {
						...
						if ((z("Language definition for '{}' could not be registered.".replace("{}", e)), !o)) throw t
						z(t), (s = l)
					}
					s.name || (s.name = e),
						(i[e] = s),
	...
	var e = (() => {
		...
		return (e) => {
			const a = e.regex,
				...
				s = /[^\s!"#%&'()*+,.\/;<=>@\[\\\]^`{|}~]+/,
				i = a.either(/""|"[^"]+"/, /''|'[^']+'/, t, s),
				r = a.concat(a.optional(/\.|\.\/|\//), i, a.anyNumberOfTimes(a.concat(/(\.|\/)/, i))),
				l = a.concat("(", t, "|", s, ")(?==)"),
				c = {
					begin: r,
				},
				o = e.inherit(c, {
					keywords: { $pattern: /[\w.\/]+/, literal: ["true", "false", "undefined", "null"] },
				}),
				m = { begin: /\(/, end: /\)/ },
				d = {
					className: "attr",
			...
			m.contains = [b]
			const u = e.inherit(c, { keywords: n, className: "name", starts: e.inherit(g, { end: /\}\}/ }) }),
		...
		return (o) => {
			const l = o.regex,
				...
				N = {
					...
					starts: { end: "`", returnEnd: !1, contains: [o.BACKSLASH_ESCAPE, y], subLanguage: "graphql" },
				},
			...
			const S = [].concat(p, y.contains),
				w = S.concat([{ begin: /(\s*)\(/, end: /\)/, keywords: g, contains: ["self"].concat(S) }]),
				R = {
					className: "params",
					begin: /(\s*)\(/,
					end: /\)/,
				...
				x = {
					match: l.concat(
						/\b/,
						((T = [...r, "super", "import"].map((e) => e + "\\s*\\(")), l.concat("(?!", T.join("|"), ")")),
						d,
						l.lookahead(/\s*\(/)
					),
		...
		return (e) => {
			const t = e.regex,
				...
				h = {
					variants: [
						{
							match: [/new/, t.concat(l, "+"), t.concat("(?!", g(E).join("\\b|"), "\\b)"), n],
							scope: {
								1: "keyword",
								4: "title.class",
							},
				...
				I = {
					variants: [
						...
						{
							match: [n, t.concat(/::/, t.lookahead(/(?!class\b)/)), m],
				...
				f = { scope: "attr", match: t.concat(r, t.lookahead(":"), t.lookahead(/(?!::)/)) },
				v = {
					relevance: 0,
					begin: /\(/,
					end: /\)/,
					keywords: u,
					contains: [f, c, I, e.C_BLOCK_COMMENT_MODE, d, _, h],
				},
				O = {
					relevance: 0,
					match: [
						/\b/,
						t.concat("(?!fn\\b|function\\b|", g(b).join("\\b|"), "|", g(E).join("\\b|"), "\\b)"),
						r,
						t.concat(l, "*"),
						t.lookahead(/(?=\()/),
					],
			...
			v.contains.push(O)
			const y = [f, I, e.C_BLOCK_COMMENT_MODE, d, _, h],
				w = {
					begin: t.concat(/#\[\s*\\?/, t.either(n, o)),
					beginScope: "meta",
					end: /]/,
					endScope: "meta",
					...
					contains: [
						...
						...y,
						{ scope: "meta", variants: [{ match: n }, { match: o }] },
					],
				}
			return {
				case_insensitive: !1,
					...
					h,
					{
						...
						contains: [
							...
							{ begin: "=>", endsParent: !0 },
							{
								...
								excludeEnd: !0,
								keywords: u,
								contains: ["self", w, c, I, e.C_BLOCK_COMMENT_MODE, d, _],
							},
						],
					},
					{
	...
	var e = (() => {
		...
		return (e) => {
			const n = "true false yes no null",
				...
				l = { end: ",", endsWithParent: !0, excludeEnd: !0, keywords: n, relevance: 0 },
